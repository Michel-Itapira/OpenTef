...
begin
    try
        ...
        F_MensagemGetTag(VL_Mensagem, PChar('0024'), VL_ChaveModulo);
        F_MensagemGetTag(VL_Mensagem, PChar('0023'), VL_ChaveExpoente);
        F_MensagemGetTag(VL_Mensagem, PChar('0028'), VL_PChar);
        F_MensagemGetTag(VL_Mensagem, PChar('010E'), VL_ChaveComunicacaoSolicitacao);
        F_MensagemGetTag(VL_Mensagem, PChar('010F'), VL_ChaveComunicacaoResposta);
        if VL_PChar <> '' then
        ...
        begin
            ...
            F_MensagemGetTag(VL_Mensagem_Dados, PChar('0005'), VL_PChar);            // versao do tef
        ...
        begin
            ...
            if VL_Pan = '' then
                F_MensagemGetTag(VL_Mensagem_Dados, PChar('011A'), VL_Pan);                 // pan nao enviado de proposito
...
var
    VL_Pan, VL_WK, VL_Senha: ansistring;
    VL_Resultado: string;
begin
    VL_Resultado := '';
