...
begin
    try
        ...
        if ((F_MensagemComando(VL_Mensagem) = '00F0') and (F_MensagemComandoDados(VL_Mensagem) = 'S')) then        // CONSULTAR SALDO
        begin
            VL_TagDados := '';
            ...
            F_MensagemGetTag(VL_Mensagem_Dados, PChar('00E7'), VL_Pan);            // pan
