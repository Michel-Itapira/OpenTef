...
type
    ...
    TFCadModulo = class(TForm)
        ...
        procedure MDModuloFuncFilterRecord(DataSet: TDataSet;
          var Accept: Boolean);
...
{$R *.lfm}
uses
    uinterface, uPesquisaTags, upesquisamodulo;
...
procedure TFCadModulo.MDModuloFuncFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
