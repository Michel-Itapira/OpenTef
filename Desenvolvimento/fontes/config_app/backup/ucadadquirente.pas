...
{$R *.lfm}
USES
    uinterface,uPesquisaadquirentes;
...
begin
    ...
    try
        ...
        begin
            ...
            MDAdquirente.FieldByName('IDENTIFICACAO').AsString := EIdentificacao.Text;
...
begin
    ...
    EIdentificacao.Text := MDAdquirente.FieldByName('IDENTIFICACAO').AsString;
