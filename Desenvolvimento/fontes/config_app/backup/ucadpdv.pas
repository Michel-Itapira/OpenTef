...
begin
    ...
    try
        ...
        begin
            ...
            MDPinPad.Locate('FABRICANTE_MODELO', CPinPad.KeyValue, []);
            ...
            MDPdv.FieldByName('IDENTIFICACAO').AsString := EIdentificacao.Text;
            MDPdv.FieldByName('PINPAD_COM').AsString := EPinPadCom.Text;
            MDPdv.FieldByName('CHAVE').AsString := EChave.Text;
...
begin
    ...
    EIdentificacao.Text := MDPdv.FieldByName('IDENTIFICACAO').AsString;
    EIP.Text := MDPdv.FieldByName('IP').AsString;
    EPinPadCom.Text := MDPdv.FieldByName('PINPAD_COM').AsString;
    EChave.Lines.Text := MDPdv.FieldByName('CHAVE').AsString;
