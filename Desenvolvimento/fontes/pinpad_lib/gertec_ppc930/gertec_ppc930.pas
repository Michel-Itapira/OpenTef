...
type
  ...
  Tabecs_cmd_cex = procedure(pinpad: Pointer; cexOp: PChar; timeout: Pointer;
    panMask: Pointer) stdcall;
  ...
  Tabecs_cmd_mli = function(pinpad: Pointer; filename: PChar;
    filesize: uint32; crc16: uint16; tipo: uint8): integer; stdcall;
  Tabecs_cmd_mlr = function(pinpad: Pointer; Data: TUnit8; SIZE_T: SIZE_T): integer;
    stdcall;
  ...
  Tabecs_cmd_cex_response = function(pinpad: Pointer; outmap: Pointer;
    outNotify: Pointer): integer; stdcall;
  ...
  Tabecs_cmd_gpn_response = function(pinpad: Pointer; outmap: Pointer;
    outNotify: Pointer): integer; stdcall;
  ...
  public
    ...
    procedure SetConfig(VP_PinPad: TPinPadModelo; VP_CaminhoLib: ansistring;
      VP_Porta: ansistring); override;
    ...
    function PinPadLerTarja(var VO_Tarja1, VO_Tarja2, VO_Tarja3: string;
      VP_TempoEspera: integer; var VO_Mensagem: TMensagem): integer; override;
    function PinPadLerSenha(var VO_Senha: string; VP_KW_Index: integer;
      VP_KW, VP_Pan: string; VP_DigMin, VP_DigMax: integer;
...
begin
  ...
  {$IFDEF WIN32}
    ...
    Pointer(abecs_comm_open) := GetProcAddress(fPinPadLib, 'abecs_comm_open@4');
    Pointer(abecs_comm_close) := GetProcAddress(fPinPadLib, 'abecs_comm_close@4');

    Pointer(abecs_cmd_opn) := GetProcAddress(fPinPadLib, 'abecs_cmd_opn@8');
    Pointer(abecs_cmd_dsp) := GetProcAddress(fPinPadLib, 'abecs_cmd_dsp@8');
    Pointer(abecs_cmd_clo) := GetProcAddress(fPinPadLib, 'abecs_cmd_clo@8');
    Pointer(abecs_cmd_cex) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex@16');
    Pointer(abecs_cmd_gpn) := GetProcAddress(fPinPadLib, 'abecs_cmd_gpn@8');


    Pointer(abecs_cmd_mlx) := GetProcAddress(fPinPadLib, 'abecs_cmd_mlx@16');
    Pointer(abecs_cmd_dsi) := GetProcAddress(fPinPadLib, 'abecs_cmd_dsi@8');
    Pointer(abecs_cmd_mli) := GetProcAddress(fPinPadLib, 'abecs_cmd_mli@20');
    Pointer(abecs_cmd_mlr) := GetProcAddress(fPinPadLib, 'abecs_cmd_mlr@12');
    Pointer(abecs_cmd_mle) := GetProcAddress(fPinPadLib, 'abecs_cmd_mle@4');
    Pointer(abecs_cmd_mlx_crc16) := GetProcAddress(fPinPadLib, 'abecs_cmd_mlx_crc16@4');



    Pointer(abecs_cmd_cex_response) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response@12');

    Pointer(abecs_rsp_param_map_new) := GetProcAddress(fPinPadLib, 'abecs_rsp_param_map_new@0');

    Pointer(pcl_map_delete) := GetProcAddress(fPinPadLib, 'pcl_map_delete@4');

    Pointer(abecs_cmd_cex_response_get_event) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_event@4');
    Pointer(abecs_cmd_cex_response_get_trk1inc) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk1inc@4');
    Pointer(abecs_cmd_cex_response_get_trk2inc) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk2inc@4');
    Pointer(abecs_cmd_cex_response_get_trk3inc) := GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk3inc@4');
    Pointer(abecs_cmd_gpn_response) := GetProcAddress(fPinPadLib, 'abecs_cmd_gpn_response@12');
  ...
  Pointer(abecs_cmd_cex_response) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response');

  Pointer(abecs_rsp_param_map_new) :=
    GetProcAddress(fPinPadLib, 'abecs_rsp_param_map_new');

  Pointer(pcl_map_delete) := GetProcAddress(fPinPadLib, 'pcl_map_delete');

  Pointer(abecs_cmd_cex_response_get_event) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_event');
  Pointer(abecs_cmd_cex_response_get_trk1inc) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk1inc');
  Pointer(abecs_cmd_cex_response_get_trk2inc) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk2inc');
  Pointer(abecs_cmd_cex_response_get_trk3inc) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_cex_response_get_trk3inc');
  Pointer(abecs_cmd_gpn_response) :=
    GetProcAddress(fPinPadLib, 'abecs_cmd_gpn_response');
...
procedure TGertec_ppc930.SetConfig(VP_PinPad: TPinPadModelo;
  VP_CaminhoLib: ansistring; VP_Porta: ansistring);
begin
  fPorta := VP_Porta;
...
function TGertec_ppc930.PinPadLerTarja(var VO_Tarja1, VO_Tarja2, VO_Tarja3: string;
  VP_TempoEspera: integer; var VO_Mensagem: TMensagem): integer;
var
...
function TGertec_ppc930.PinPadLerSenha(var VO_Senha: string;
  VP_KW_Index: integer; VP_KW, VP_Pan: string; VP_DigMin, VP_DigMax: integer;
...
begin
  ...
  while (VL_Retorno = -1) and (VF_PinpadExecption = False) and
    (VL_Notificacao.msg[0] = #0) do
  begin
    sleep(10);
