...
public interface TefLib extends Library {	
	   ...
	   int mensagemcreate(Pointer ponteiro);
	   int mensagemcarregatags(Pointer ponteiro, String dados);
	   int mensagemcomando(Pointer ponteiro, String dados);
	   int mensagemcomandodados(Pointer ponteiro,String dados);
	   ...
	   int mensagemgettag(Pointer ponteiro, String tag, String dados);
