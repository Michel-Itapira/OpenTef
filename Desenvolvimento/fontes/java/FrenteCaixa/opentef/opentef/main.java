...
public class main {
	...
	private static Pointer tef_pointer;
	...
	public static void main(String[] args) {
		...
		btnTeste.addActionListener(e -> {
			...
			try {
				...
				erro = teflib.mensagemcreate(mensagem);
		...
		btnInicializar.addActionListener(e -> {
			...
			tef_pointer = new Memory(42);

			int erro = teflib.inicializar(tef_pointer, 0, "", "", "", "", retornoClienteImpl, solicitaDadosTransacaoImpl,
					solicitaDadosPDVImpl, imprimirImpl, mostraMenuImpl, mensagemOperadorImple, 0);
			if (erro != 0) {
