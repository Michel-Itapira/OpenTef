...
begin
    ...
    try
        ...
        on e: Exception do
            GravaLog(VL_ArquivoLog, 0, '', 'modulo', '190520221827', 'Erro na finalizacao do modulo finalizar() ' + e.ClassName + '/' + e.Message, '', 1, 1);
...
begin
    ...
    try
        ...
        if F_NivelLog >= 1 then
            GravaLog(TDModulo(VP_Modulo).V_ArquivoLog, 0, 'solicitacaoblocante', 'modulo', '131120230958', 'mensagem recebida', VL_Dados, 0);
