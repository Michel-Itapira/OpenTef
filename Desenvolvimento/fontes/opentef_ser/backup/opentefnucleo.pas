...
uses
    ...
    funcoes, rxmemds, IdContext, cadastro, LbClass, md5, base64, FMTBcd, DB, bancodados, Forms;
...
type
    ...
    TLogin = function(VP_Modulo: Pointer; VP_Host: PChar; VP_Porta: integer; VP_ChaveComunicacao, VP_TipoConexao, VP_Identificacao: PChar): integer; cdecl;
    ...
    TSolicitacaoblocante = function(VP_Modulo: Pointer; VP_Transmissao_ID, VP_Dados: PChar; var VO_Retorno: PChar;
    ...
    public
        ...
        constructor Create(VP_Suspenso: boolean; VP_Bin: TRecBin; VP_Dados: string; VP_Transacao_ID: string; VP_ArquivoLog: string;
    ...
    private
        ...
        function comando0113(VP_Transmissao_ID: string; VP_Mensagem: TMensagem; VP_Conexao_ID: integer): integer;
        ...
        try
            ...
            begin
                ...
                VL_Erro := DNucleo.comando0105(VP_Transmissao_ID, VP_Tarefa_ID,
                    VP_ModuloProcID, VL_PRegModulo^.ModuloConfig_ID, VP_Erro,
                    VL_PRegModulo^.Tag, VL_String);   //COMANDO PARA SER EXECUTADO NOS TERMINAIS CLIENTES

                //VL_Erro := VL_PRegModulo^.Solicitacao(VL_PRegModulo^.PModulo,
                //PChar(VP_Transmissao_ID), PChar(VL_String), nil, VP_Tarefa_ID, 30000);
            ...
            begin
                ...
                begin
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo',
                        '090920221435', 'ModuloCaixaRetorno, recebeu comando com erro', '', VP_Erro, 1);
                end;
        ...
        try
                ...
                begin
                    ...
                    begin
                        ...
                        Pointer(TRegModulo(VF_RegModulo^).Inicializar) :=
                            GetProcAddress(TRegModulo(VF_RegModulo^).Handle, 'inicializar');
                        Pointer(TRegModulo(VF_RegModulo^).Solicitacao) :=
                            GetProcAddress(TRegModulo(VF_RegModulo^).Handle, 'solicitacao');
                        Pointer(TRegModulo(VF_RegModulo^).Solicitacaoblocante) :=
                            GetProcAddress(TRegModulo(VF_RegModulo^).Handle, 'solicitacaoblocante');
                        Pointer(TRegModulo(VF_RegModulo^).ModuloStatus) :=
                            GetProcAddress(TRegModulo(VF_RegModulo^).Handle, 'modulostatus');
                        ...
                        if VF_ConexaoTipo = cnCaixa then
                            VL_Erro :=
                                ...
                                TRegModulo(VF_RegModulo^).ModuloConfig_ID, PChar(VF_ArquivoLog))
                        else
                            VL_Erro :=
                                TRegModulo(VF_RegModulo^).Inicializar(
                                TRegModulo(VF_RegModulo^).ModuloProcID,
                    ...
                    begin
                        ...
                        VL_Erro :=
                            TRegModulo(VF_RegModulo^).ModuloStatus(TRegModulo(VF_RegModulo^).PModulo,
                            VL_VersaoModulo, VL_VersaoMensagem, VL_DadosInteger);
                        if VL_Erro <> 0 then
                        begin
                            GravaLog(VF_ArquivoLog,
                                TRegModulo(VF_RegModulo^).ModuloConfig_ID, TRegModulo(VF_RegModulo^).Tag,
                        ...
                        begin
                            VL_Erro := TRegModulo(VF_RegModulo^).Login(
                                TRegModulo(VF_RegModulo^).PModulo,
                                PChar(TRegModulo(VF_RegModulo^).Host),
                                TRegModulo(VF_RegModulo^).Porta, PChar(TRegModulo(VF_RegModulo^).Chave),
                                VL_TipoConexao,
                                PChar(TRegModulo(VF_RegModulo^).Identificador));
                            if VL_Erro <> 0 then
                                GravaLog(VF_ArquivoLog,
                            ...
                            begin
                                ...
                                try
                                    ...
                                    TRegModulo(VF_RegModulo^).Solicitacao(
                                        TRegModulo(VF_RegModulo^).PModulo, PChar(''),
                        ...
                        begin
                                ...
                                begin
                                    ...
                                    if VF_ConexaoTipo = cnCaixa then
                                        VL_Erro :=
                                            TRegModulo(VF_RegModulo^).Solicitacao(
                                            TRegModulo(VF_RegModulo^).PModulo, PChar(
                                            VL_Tarefa^.VF_TransmissaoID), PChar(VL_Tarefa^.VF_Mensagem), @ModuloCaixaRetorno,
                                            VL_Tarefa^.VF_ID, VL_Tarefa^.VF_TempoEspera)
                                    else
                                        VL_Erro :=
                                            TRegModulo(VF_RegModulo^).Solicitacao(
                                            TRegModulo(VF_RegModulo^).PModulo, PChar(
                                            VL_Tarefa^.VF_TransmissaoID), PChar(VL_Tarefa^.VF_Mensagem), @ModuloServicoRetorno, VL_Tarefa^.VF_ID,
                                            VL_Tarefa^.VF_TempoEspera);
                            ...
                            begin
                                ...
                                if ((TimeStampToMSecs(DateTimeToTimeStamp(now)) -
                                    TimeStampToMSecs(DateTimeToTimeStamp(VL_Tarefa^.VF_DataCriacao))) >
            ...
            on e: Exception do
                GravaLog(F_ArquivoLog, TRegModulo(VF_RegModulo^).ModuloConfig_ID,
                    '', 'opentefnucleo', '200520220934', 'Erro na TThModulo.Execute ' +
                    e.ClassName + '/' + e.Message, '', VL_Erro, 1);
        end;
    finally
        try
            if TRegModulo(VF_RegModulo^).Handle <> 0 then
            ...
            on e: Exception do
                GravaLog(F_ArquivoLog, TRegModulo(VF_RegModulo^).ModuloConfig_ID,
                    '', 'opentefnucleo', '290820222000', 'Erro na TThModulo.Execute ' +
                    e.ClassName + '/' + e.Message, '', VL_Erro, 1);
...
//    ZConexao.LibraryLocation := ExtractFilePath(ParamStr(0)) + 'firebird/libfbclient.so';
    ...
    {$ELSE}
    {
    ZConexao.Database := ExtractFilePath(ParamStr(0)) + '../firebird/opentef.fdb';
    ...
    {$ELSE}
    {$IFDEF UNIX}
    ZConexao.LibraryLocation := ExtractFilePath(ParamStr(0)) + 'libfbclient.so';
    ZConexao.HostName:='localhost';
    ZConexao.Database := 'opentef';
    ZConexao.User:='SYSDBA';
    ZConexao.Port:=25050;
    ...
    {$ELSE}
        ZConexao.LibraryLocation :=
            ExtractFilePath(ParamStr(0)) + 'firebird\fbclient.dll';
        ZConexao.Database := ExtractFilePath(ParamStr(0)) + 'opentef.fdb';
    {$ENDIF UNIX}
    ...
    {$ENDIF DEBUG}
        ...
        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '2022110812319',
            'TDNucleo.iniciar ' + 'TentandoConectandoBanco LIB:' +
        ...
        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '2022110812316',
            'TDNucleo.iniciar ' + 'ConectandoBanco...', '', 0, 3);
        ...
        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '2022110812317',
            'TDNucleo.iniciar ' + 'ConectadoBanco...', '', 0, 3);
...
begin
    try
        try
            ...
            on e: Exception do
            begin
                GravaLog(F_ArquivoLog, 0, 'atualizaConfiguracao', 'opentefnucleo', '141120231603',
...
begin
    ...
    try
        try
            ...
            VL_BancoDados.ConsultaA.Close;
            VL_BancoDados.ConsultaA.SQL.Text := 'SELECT ' +
                ...
                ' LEFT OUTER JOIN CHAVE C ' +
                ' ON MC.CHAVE_ID = C.ID ' +
                ' LEFT OUTER JOIN IDENTIFICACAO I ' +
                ' ON MC.IDENTIFICACAO_ID = I.ID ' +
                ' WHERE MC.HABILITADO=''T'' AND ((MC.ID=' + IntToStr(VP_ModuloConfig_ID) +
                ') OR (0=' + IntToStr(VP_ModuloConfig_ID) + '))';
            ...
            begin
                ...
                VL_RegModulo^.AdquirenteTag := VL_BancoDados.ConsultaA.FieldByName('ADQUIRENTE_TAG_NUMERO').AsString;
                VL_RegModulo^.ModuloConfig_ID := VL_BancoDados.ConsultaA.FieldByName('ID').AsInteger;
                VL_RegModulo^.Biblioteca := VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString + C_Lib;
                VL_RegModulo^.Tag := VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString;
                VL_RegModulo^.Host := VL_BancoDados.ConsultaA.FieldByName('SERVICO_HOST').AsString;
                VL_RegModulo^.Porta := VL_BancoDados.ConsultaA.FieldByName('SERVICO_PORTA').AsInteger;
                VL_RegModulo^.Chave := VL_BancoDados.ConsultaA.FieldByName('CHAVE_COMUNICACAO').AsString;
                ...
                VL_RegModulo^.ThModulo :=
                    ...
                    PChar(ExtractFilePath(ParamStr(0)) + VL_BancoDados.ConsultaA.FieldByName(
                    'TAG_NUMERO').AsString + '_servico.txt'), DNucleo);
           ...
           {     F_Modulo_ID_Contador := F_Modulo_ID_Contador + 1;
                ...
                VL_RegModulo^.Biblioteca := VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString + C_Lib;
                VL_RegModulo^.Tag := VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString;
                VL_RegModulo^.Host := VL_BancoDados.ConsultaA.FieldByName('CAIXA_HOST').AsString;
                VL_RegModulo^.Porta := VL_BancoDados.ConsultaA.FieldByName('CAIXA_PORTA').AsInteger;
                VL_RegModulo^.Chave := VL_BancoDados.ConsultaA.FieldByName('CHAVE_COMUNICACAO').AsString;
                VL_RegModulo^.Identificador := VL_BancoDados.ConsultaA.FieldByName('IDENTIFICADOR').AsString;
                VL_RegModulo^.Descricao := VL_BancoDados.ConsultaA.FieldByName('DESCRICAO').AsString;
                VL_RegModulo^.Bin_Estatico := VL_BancoDados.ConsultaA.FieldByName('BIN_ESTATICO').AsBoolean;
            ...
            on e: Exception do
            begin
                GravaLog(F_ArquivoLog, 0, 'ModuloCarrega', 'opentefnucleo', '141120231610',
                    'excecao ' + e.ClassName + '/' + e.Message, '', 1, 1);
            end;
        end;
    finally
...
begin
    ...
    Result := VP_RegModulo.ModuloStatus(VP_RegModulo.PModulo, VL_VersaoModulo, VL_VersaoMensagem, VL_DadosInteger);
    if Result <> 0 then
    begin
        GravaLog(VP_RegModulo.ThModulo.VF_ArquivoLog,
            ...
            '101120230904',
            'Erro ao tentar pegar status da conexao ' +
            ConexaoTipoToStr(VP_RegModulo.ThModulo.VF_ConexaoTipo) + ' da dll:' +
            VP_RegModulo.Biblioteca,
            '', Result, 1);
        Exit;
    end;
    ...
    try
        try
            ...
            VL_BancoDados.ConsultaA.SQL.Text :=
                'SELECT MODULO.TAG_NUMERO, M.ID AS MODULO_CONF_ID, M.BIN_ESTATICO AS BIN_ESTATICO , B.IIN as BIN ' + ' FROM' +
                ' MODULO_CONF M' + ' INNER JOIN BIN B ON B.MODULO_CONF_ID=M.ID' +
            ...
            begin
                VF_Bin.Add(VL_BancoDados.ConsultaA.FieldByName('BIN').AsString,
                    VP_RegModulo.ModuloConfig_ID, VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString);
                VL_BancoDados.ConsultaA.Next;
            end;
        ...
        try
            ...
            begin
                ...
                VL_BancoDados.ConsultaA.SQL.Text :=
                    ...
                    'INNER JOIN TAG ON TAG.TAG_NUMERO=MODULO_FUNCAO.TAG_NUMERO AND TAG.TAG_TIPO=''MENU_PDV'' ' + 'WHERE MODULO_CONF.ID=' +
                ...
                begin
                    VL_Tag.Dados := VL_BancoDados.ConsultaA.FieldByName('DADOS').AsString;
                    VL_Tag.Tag := VL_BancoDados.ConsultaA.FieldByName('TAG_NUMERO').AsString;
            ...
            if ((VP_Mensagem.GetTagAsAstring('007D') = '') and
                (VP_Mensagem.GetTagAsAstring('004D') = '0')) then  // não é para atualizar o menu
                Exit;
            ...
            on e: Exception do
            begin
                GravaLog(F_ArquivoLog, 0, 'AtualizaMENU', 'opentefnucleo', '141120231617',
                    'excecao ' + e.ClassName + '/' + e.Message, '', 1, 1);
            end;
        end;
    finally
...
begin
    ...
    try
        try
            ...
            on e: Exception do
            begin
                GravaLog(F_ArquivoLog, 0, 'AtualizaMENU_OPERACIONAL', 'opentefnucleo', '141120231619',
                    'excecao ' + e.ClassName + '/' + e.Message, '', 1, 1);
            end;
        end;
    finally
...
begin
    ...
    try
        ...
        begin
            ...
            VL_RecConciliacao^.ThConciliacao := TThConciliacao.Create(True, VL_RecConciliacao^.bin, VL_RecConciliacao^.dados,
                VL_RecConciliacao^.transacao_id, F_ArquivoLog, DNucleo, self.Conexao_ID);
        ...
        begin
            ...
            begin
                ...
                begin
                    ...
                    begin
                        VL_Mensagem.AddTag(VL_Posicao, '0000', VL_RecConciliacao^.transacao_id + VL_RecConciliacao^.bin.IIN);
...
constructor TThConciliacao.Create(VP_Suspenso: boolean; VP_Bin: TRecBin; VP_Dados: string; VP_Transacao_ID: string;
    VP_ArquivoLog: string; VP_DNucleo: Pointer; VP_Conexao_ID: integer; VP_TempoEspera: integer = 60000);
begin
        ...
        try
            begin
                ...
                begin
                    ...
                    begin
                        VL_TRegModulo := DNucleo.ModuloGetModuloConfigID(VF_Bin.ModuloConfID, cnServico);

                        if VL_TRegModulo.ModuloConfig_ID = -1 then // modulo da operadora nao carregado
                        begin
                            VF_Status := ssErro;
                            VL_Mensagem.Limpar;
                            VL_Mensagem.AddComando('0000', '');
                        ...
                        VL_Erro := DComunicador.ServidorTransmiteSolicitacaoID(
                        ...
                        VL_Erro :=
                            VL_TRegModulo.Solicitacaoblocante(VL_TRegModulo.PModulo, PChar(VF_Transmissao_ID),
                            PChar(VL_Retorno.TagsAsString), VL_DadosRecebidos,
                            VF_TempoEspera);
                        ...
                        VL_Erro :=
                            VL_TRegModulo.Solicitacaoblocante(VL_TRegModulo.PModulo, PChar(VF_Transmissao_ID),
                            PChar(VL_Mensagem.TagsAsString), VL_DadosRecebidos,
                            VF_TempoEspera);
            ...
            on e: Exception do
                GravaLog(F_ArquivoLog, 0,
                    '', 'opentefnucleo', '221120231050', 'Erro na TThConciliacao.Execute ' +
                    e.ClassName + '/' + e.Message, '', VL_Erro, 1);
        end;
    finally
        try
            ...
            on e: Exception do
                GravaLog(F_ArquivoLog, 0,
                    '', 'opentefnucleo', '221120231051', 'Erro na TThConciliacao.Execute ' +
                    e.ClassName + '/' + e.Message, '', VL_Erro, 1);
        end;
    end;
end;
...
begin
    VL_Mensagem := nil;
    try
        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231255', 'Mensagem recebida no comando', VP_DadosRecebidos, VP_Erro, 2);
        ...
        begin
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '250820221507',
                ...
                VP_DadosRecebidos + ' Conexao ID: ' + IntToStr(VP_Conexao_ID), VP_Erro, 1);
        ...
        begin
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '120920220842',
                'TDNucleo.comando, erro ao carregar tags', VP_DadosRecebidos, VL_Erro, 1);
            DComunicador.DesconectarClienteID(DComunicador, VP_Conexao_ID);
            Exit;
        end;
        ...
        case VL_Mensagem.Comando() of
            ...
            '000A': Result := comando000A(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Terminal_Status, VP_Terminal_ID, VP_Terminal_Tipo,
                    VP_DOC, VP_Terminal_Identificacao);
            ...
            '0088': Result := comando0088(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Permissao);   // EXCLUIR MULTILOJA_MODULO_CONF_FUNCAO
            ...
            '00B0': Result := comando00B0(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Permissao);   // ALTERAR MULTILOJA_MODULO_CONF_FUNCAO
            ...
            '00CA': Result := comando00CA(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Permissao);   // INCLUIR MULTILOJA_MODULO_CONF_FUNCAO
            ...
            '00FA': Result := comando00FA(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Permissao);   // INCLUIR LOJA EM MULTILOJA(GUARDA-CHUVA)
            '00FB': Result := comando00FB(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Permissao);   // EXCLUIR LOJA EM MULTILOJA(GUARDA-CHUVA)
            ...
            '00F5': Result := comando00F5(VP_Transmissao_ID, VL_Mensagem,
                    VP_Conexao_ID, VP_Terminal_Status, VP_Terminal_ID);   // MENU OPERACIONAL
...
begin
    ...
    try
        try
            ...
            VL_BancoDados.ConsultaA.Close;
            VL_BancoDados.ConsultaA.SQL.Text := 'SELECT S_STATUS,S_TERMINAL,S_DOC,S_IDENTIFICACOR FROM P_VAL_TERMINAL(' +
                StrToSql(VL_IP, False, 40) + ',' +
                CLNValoresSQL(VL_ID) + ',' +
            ...
            begin
                VL_Mensagem.AddTag('004D', VL_BancoDados.ConsultaA.FieldByName('S_STATUS').AsString);
                Result := VL_BancoDados.ConsultaA.FieldByName('S_STATUS').AsInteger;
                DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                    3000, False, nil, VP_Transmissao_ID, VL_Mensagem, VL_Mensagem, VP_Conexao_ID);
                Exit;
            end;
            ...
            if DComunicador.V_ConexaoCliente.GetSocketServidorIdentificacao(DComunicador, VL_BancoDados.ConsultaA.FieldByName('S_TERMINAL').AsString,
                VL_BancoDados.ConsultaA.FieldByName('S_IDENTIFICACOR').AsString, VL_AContextDuplicada) then
            begin
                Result := DComunicador.DesconectarClienteID(DComunicador, TTConexao(VL_AContextDuplicada.Data).ID);

                if Result <> 0 then
                begin
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231755', 'Erro na comando0001 não foi possivel deburar a coneão duplicada ',
                        '', Result, 1);
                    Exit;
                end;
            end;

            TTConexao(VL_AContext.Data).Identificacao := VL_BancoDados.ConsultaA.FieldByName('S_IDENTIFICACOR').AsString;
            ...
            VL_BancoDados.ConsultaA.Close;
            VL_BancoDados.ConsultaA.SQL.Text := 'SELECT VERSAO_TEF_LIB,VERSAO_COM_LIB FROM CONFIG';
            VL_BancoDados.ConsultaA.Open;
            ...
            if VP_Mensagem.GetTagAsAstring('003D') = 'tef_lib' then
                VL_VersaoAtual := StrToVer(VL_BancoDados.ConsultaA.FieldByName('VERSAO_TEF_LIB').AsString)
            else if VP_Mensagem.GetTagAsAstring('003D') = 'com_lib' then
                VL_VersaoAtual := StrToVer(VL_BancoDados.ConsultaA.FieldByName('VERSAO_COM_LIB').AsString)
            else
            ...
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231256', 'Mensagem enviada no comando0001', VL_Mensagem.TagsAsString, 0, 2);

            DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                3000, False, nil, VP_Transmissao_ID, VL_Mensagem, VL_Mensagem, VP_Conexao_ID);
        except
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, '0001', 'opentefnucleo', '141120231539', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_Mensagem.Free;
        VL_BancoDados.Free;
    ...
    try
        try
            ...
            begin
                ...
                DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                    3000, False, nil, VP_Transmissao_ID, VP_Mensagem, VP_Mensagem, VP_Conexao_ID);
                exit;
            end;
    ...
    try
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231301', 'Mensagem enviada no comando00F5', VP_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231302', 'Mensagem enviada no comando00F5', VP_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    if VL_BancoDados.ConsultaA.FieldByName('S_HABILITADO').AsString = 'T' then
                        VF_MenuOperacional.Add(VL_BancoDados.ConsultaA.FieldByName(
                            'S_TAG_NUMERO').AsString, VL_BancoDados.ConsultaA.FieldByName(
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231303', 'Mensagem enviada no comando00F5', VP_Mensagem.TagsAsString, 0, 2);
            ...
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, '0018', 'opentefnucleo', '141120231540', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_BancoDados.Free;
    end;
...
begin
    ...
    try
        try
            ...
            begin
                VL_ChaveTransacao := PChar(VL_Mensagem.GetTagAsAstring('00F1').Trim);
            ...
            begin
                VL_Mensagem.Limpar;
                VL_Mensagem.AddComando('008C', 'S'); // solicita atualizacao da tag
                VL_Mensagem.AddTag('011A', VL_Transacao.GetTagAsAstring('004F')); // pan digitado pelo pinpad
                // pan
                VL_Mensagem.AddTag('0062', '0000' +
                    Copy(VL_Transacao.GetTagAsAstring('004F'), 7, 12));  //pan mascarado
                VL_Mensagem.AddTag('0036', Copy(VL_Transacao.GetTagAsAstring('004F'), 1, 6));
                //bin

                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231307', 'Mensagem enviada no comando000A', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                begin
                    ...
                    VL_BancoDados.ConsultaA.SQL.Text :=
                        ...
                        ' WHERE S_HABILITADO=''T'' AND S_TAG_NUMERO=''' +
                        VL_RecBin.ModuloTag + '''';
                    VL_BancoDados.ConsultaA.Open;
                    ...
                    begin
                        ...
                        VL_Chave00F1.AddTag('00F9',
                            PChar(VL_BancoDados.ConsultaA.FieldByName('S_LOJA_CODIGO').AsString));
                        // codigo da loja
                        VL_Chave00F1.AddTag('0107',
                            PChar(VL_BancoDados.ConsultaA.FieldByName('S_PDV_CODIGO').AsString)); // codigo do pdv
                        ...
                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231315', 'Mensagem enviada no comando000A', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    VL_Erro :=
                        ...
                        VL_TempoEmperaComandao, VL_RecBin.ModuloConfID,
                        VL_Mensagem, cnCaixa);
    ...
    try
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120230825', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '211120231544', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '211120231654', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120230828', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231632', 'Mensagem enviada no comando000A', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231611', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231615', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '241120231316', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            VL_Erro := VL_TagConciliacao.CarregaTags(VL_DadosSolicitacao); // CARREGA TABELA DE CONCILIACAO

            if VL_Erro <> 0 then
            begin
                GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                    '211120231629', 'Erro ao carregar a tag de conciliacao', '', VL_Erro, 1);
                Result := VL_Erro;
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120230831', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                VL_Chave00F1.AddTag('0091', TTConexao(VL_AContext.Data).DOC);  // documento(cpf ou cnpj)
                VL_Chave00F1.AddTag('00F9', '');
            ...
            VL_BancoDados.ConsultaA.Close;
            VL_BancoDados.ConsultaA.SQL.Text := 'SELECT S_TAG_NUMERO,S_HABILITADO,S_LOJA_CODIGO FROM ' +
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '211120231656', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            for VL_I := 1 to VL_TagConciliacao.GetTagAsInteger('0119') do // quantidade de linha
            begin
                VL_TagConciliacao.GetTagTabelaPosicao(VL_I, '0036', VL_Bin); // bin
                copiaTagPosicao(VL_I, VL_TagConciliacao, VL_TagLinha);  // copiando os dados dessa linha
                VL_TagLinha.AddTag('007D', VL_Transacao.TagsAsString); // dados da transacao
                VL_TagLinha.AddTag('0114', VL_VersaoConciliacao); // versao da conciliacao
                ...
                begin
                    ...
                    while not VL_BancoDados.ConsultaA.EOF do
                    begin
                        VL_RecBin := VF_Bin.RetornaBINPorTag(VL_BancoDados.ConsultaA.FieldByName('S_TAG_NUMERO').AsString);

                        if VL_RecBin.ModuloConfID = -1 then //MODULO NAO CARREGADO PARA ESSE BIN
                        begin
                            Result := 79;
                            GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                                '221120231531', 'Não foi encontrado o modulo deste bin', '', Result, 1);

                            VL_Mensagem.Limpar;
                            VL_Mensagem.AddComando('0113', 'R'); // retorno
                            VL_Mensagem.AddTag('004D', IntToStr(Result));  // resposta com erro

                            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231532', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
                        ...
                        VL_TagLinha.AddTag('00F9', VL_BancoDados.ConsultaA.FieldByName('S_LOJA_CODIGO').AsLargeInt); // codigo do comercio para adquirente
                        ...
                        begin
                            GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                                '221120231533', 'Erro ao montar estrutura de dados da conciliacao', '', Result, 1);

                            VL_Mensagem.Limpar;
                            VL_Mensagem.AddComando('0113', 'R'); // retorno
                            VL_Mensagem.AddTag('004D', IntToStr(Result));  // resposta com erro

                            GravaLog(F_ArquivoLog, 0, VL_Transacao_ID, 'opentefnucleo', '221120231534', 'Mensagem enviada no comando0113',
                ...
                begin
                    ...
                    begin
                        Result := 79;
                        GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                            '221120231527', 'Não foi encontrado o modulo deste bin', '', Result, 1);

                        VL_Mensagem.Limpar;
                        VL_Mensagem.AddComando('0113', 'R'); // retorno
                        VL_Mensagem.AddTag('004D', IntToStr(Result));  // resposta com erro

                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231528', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    begin
                        Result := 79;
                        GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                            '221120231529', 'o pdv não tem permissao para este modulo', '', Result, 1);

                        VL_Mensagem.Limpar;
                        VL_Mensagem.AddComando('0113', 'R'); // retorno
                        VL_Mensagem.AddTag('004D', IntToStr(Result));  // resposta com erro

                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231530', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    begin
                        GravaLog(F_ArquivoLog, 0, '.comando0113', 'opentefnucleo',
                            '221120231526', 'Erro ao montar estrutura de dados da conciliacao', '', Result, 1);

                        VL_Mensagem.Limpar;
                        VL_Mensagem.AddComando('0113', 'R'); // retorno
                        VL_Mensagem.AddTag('004D', IntToStr(Result));  // resposta com erro

                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231527', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            VL_Mensagem.Limpar;
            VL_Mensagem.AddComando('0113', 'R'); // retorno
            VL_Mensagem.AddTag('0117', VL_TConciliacao.consultar); // dados da conciliacao

            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '221120231753', 'Mensagem enviada no comando0113', VL_Mensagem.TagsAsString, 0, 2);
            ...
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, 'comando0113', 'opentefnucleo', '211120231545', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_BancoDados.Free;
        VL_Mensagem.Free;
    ...
    try
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231320', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 1);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231321', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231322', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            //verifica se tem o bin ou identificacao do adquirente, para mandar para a operadora
            if ((VL_Bin = '') and (VL_Transacao.GetTagAsAstring('00D5') = '') and
                (VL_Adquirente_Identificacao = '')) then
            ...
            begin
                ...
                begin
                    ...
                    VL_Mensagem.AddComando(PChar('00E1'), PChar('S'));
                    //solicita dados da venda
                    VL_Mensagem.AddTag(PChar('00F1'), PChar(''));
                    // solicita chave da transacao da venda

                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231323', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231324', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231325', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231326', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231327', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231328', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231329', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231330', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231331', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231332', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231333', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231334', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231335', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231336', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231337', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231338', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231339', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231340', 'Mensagem enviada no comando00F4', VL_Mensagem.TagsAsString, 0, 2);
            ...
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, '00F4', 'opentefnucleo', '141120231639', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_Transacao.Free;
        VL_Chave00F1.Free;
    ...
    try
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231341', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);

                VL_PRegModulo^.Solicitacao(VL_PRegModulo^.PModulo,
                    PChar(VP_Transmissao_ID), PChar(VL_Mensagem.TagsAsString), nil,
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231342', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231343', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);
            ...
            VL_BancoDados.ConsultaA.Close;
            VL_BancoDados.ConsultaA.SQL.Text := 'SELECT P.ID, L.DOC FROM MODULO_CONF M ' +
                ...
                StrToSql(VL_CodigoLoja, True) + ' LEFT OUTER JOIN LOJA L ON  L.ID=LMC.LOJA_ID ' +
                ' LEFT OUTER JOIN PDV P ON P.id=pmc.PDV_ID AND  P.LOJA_ID=L.ID ' +
                ' LEFT OUTER JOIN IDENTIFICACAO I ON P.IDENTIFICACAO_ID = I.ID ' +
                ' WHERE M.ID=' + StrToSql(IntToStr(VP_ModuloConfigID), True) + ' AND (PMC.ID IS NOT NULL OR ' +
                StrToSql(VL_CodigoPDV, True) + ' IS NULL)' +
                ' AND I.IDENTIFICADOR= ' + StrToSql(VL_Identificacao, True);
            VL_BancoDados.ConsultaA.Open;
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '.comando0105', 'opentefnucleo',
                    '290820221430', '', '', 1, 1);
                VL_Mensagem.AddTag('004A', 'PDV não encontrado com essas informações');
                // descricao do erro

                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231404', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231405', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);
            ...
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231406', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);

            Result := DComunicador.ServidorTransmiteSolicitacaoIdentificacao(
                DComunicador, VL_TempoEmperaComandao, False, nil, VP_Transmissao_ID,
                VL_Mensagem, VL_Mensagem, VL_TerminalTipo, VL_Identificacao);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231407', 'Mensagem enviada no comando0105', VL_Mensagem.TagsAsString, 0, 2);
            ...
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, '0105', 'opentefnucleo', '141120231644', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_Transacao.Free;
        VL_Chave00F1.Free;
    ...
    try
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231408', 'Mensagem enviada no comando010D', VL_Mensagem.TagsAsString, 0, 2);

                DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                    30000, False, nil, VP_Transmissao_ID, VL_Mensagem, VL_Mensagem, VP_Conexao_ID);
                Exit;
            end;

            VL_Arquivo := TStringStream.Create;
            TBlobField(VL_BancoDados.ConsultaA.FieldByName('ARQUIVO')).SaveToStream(VL_Arquivo);
            ...
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231409', 'Mensagem enviada no comando010D', VL_Mensagem.TagsAsString, 0, 2);

            Result := DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                30000, False, nil, VP_Transmissao_ID,
                VL_Mensagem, VL_Mensagem, VP_Conexao_ID);
        except
            on E: Exception do
                GravaLog(F_ArquivoLog, 0, '010D', 'opentefnucleo', '141120231648', 'Excecao: ' + E.ClassName + '/' + E.Message, '', 1, 1);
        end;
    finally
        VL_Mensagem.Free;
        VL_BancoDados.Free;
...
begin
    ...
    VL_Adquirente_Identificacao := '';
    try
        VL_Erro := VL_Mensagem.CarregaTags(VP_Mensagem.GetTagAsAstring('00F1'));  // chave da transacao
        if VL_Erro <> 0 then
        begin
            ...
            GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231410', 'Mensagem enviada no comando0111', VL_Mensagem.TagsAsString, 0, 1);
        ...
        begin
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231411', 'Mensagem enviada no comando0111', VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231412', 'Mensagem enviada para o caixa no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231413', 'Mensagem enviada para o servico no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231414', 'Mensagem enviada no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
        ...
        begin
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231415', 'Mensagem enviada no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);

                DComunicador.ServidorTransmiteSolicitacaoID(DComunicador,
                    30000, False, nil, VP_Transmissao_ID, VP_Mensagem, VP_Mensagem, VP_Conexao_ID);
                Result := 64;
                Exit;
            end;
            ...
            begin
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231416', 'Mensagem enviada no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231417', 'Mensagem enviada no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '', 'opentefnucleo', '101120231418', 'Mensagem enviada no comando0111',
                    VL_Mensagem.TagsAsString, 0, 2);
...
begin
    ...
    try
        try
            ...
            if ((VL_Mensagem.Comando = '0022') and (VL_Mensagem.ComandoDados = 'S')) then // SOLICITA DADOS DA IDENTIFICACAO
            begin
                ...
                VL_BancoDados.ConsultaA.Close;
                VL_BancoDados.ConsultaA.SQL.Text := 'select I.ID, ' +
                    ' CASE ' +
                    ...
                    '    ELSE '''' ' +
                    ' END AS CHAVE_COMUNICACAO ' +
                    ' from identificacao i ' +
                    ' left outer join pdv p on ' +
                    ' p.IDENTIFICACAO_ID = i.ID ' +
                    ' left outer join CONFIGURADOR c on ' +
                    ' c.IDENTIFICACAO_ID = i.ID ' +
                    ' left outer join MODULO_CONF m on ' +
                    ' m.IDENTIFICACAO_ID = i.ID ' +
                    ' WHERE i.IDENTIFICADOR = ' + StrToSql(VL_Mensagem.GetTagAsAstring('0108'));
                ...
                VL_Mensagem.AddTag('0023', VL_BancoDados.ConsultaA.FieldByName('CHAVE_COMUNICACAO').AsString); // CHAVE DE COMUNICACAO
            ...
            begin
                Result := 105;
                GravaLog(F_ArquivoLog, 0, 'TransmissaoComando', 'opentefnucleo', VL_Linha, 'Excecao: ' + E.ClassName + '/' + E.Message, '', VL_Erro, 1);
            end;
        end;
    finally
        VL_BancoDados.Free;
