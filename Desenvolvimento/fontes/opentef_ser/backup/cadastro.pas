            ...
            begin
                ...
                begin
                    ...
                    VL_TLoja.ConsultaA.SQL.Text := 'INSERT INTO LOJA(DOC,RAZAO,FANTASIA,MULTILOJA_ID,HABILITADO)VALUES(' + strToSql(VL_Tabela.FieldByName(
                        'DOC').AsString) + ',' + strToSql(VL_Tabela.FieldByName('RAZAO').AsString) + ',' +
                        strToSql(VL_Tabela.FieldByName('FANTASIA').AsString) + ',' +
                        IntToSql(VL_Tabela.FieldByName('MULTILOJA_ID').AsInteger) + ',' +
                        strToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ')';
                    VL_Erro := 44;
                    VL_Linha := '300520221119';
        ...
        try
            ...
            begin
                if ((VL_Tabela.FieldByName('ID').AsInteger <> VL_TLoja.ConsultaA.FieldByName('ID').AsInteger) or
                    ((VL_Tabela.FieldByName('DOC').AsString <> VL_TLoja.ConsultaA.FieldByName('DOC').AsString) and
                    (VL_TLoja.ConsultaA.FieldByName('DOC').AsString <> ''))) then
                begin
                    VL_Mensagem.Limpar;
                    VL_Mensagem.AddComando('003F', 'R');
                ...
                VL_TLoja.ConsultaA.Close;
                VL_TLoja.ConsultaA.SQL.Text := 'UPDATE LOJA SET ' + 'DOC=' + strToSql(VL_Tabela.FieldByName('DOC').AsString) + ',' +
                    'RAZAO=' + strToSql(VL_Tabela.FieldByName('RAZAO').AsString) + ',' +
                    'MULTILOJA_ID=' + IntToSql(VL_Tabela.FieldByName('MULTILOJA_ID').AsInteger) + ',' + 'FANTASIA=' +
                    strToSql(VL_Tabela.FieldByName('FANTASIA').AsString) + ',' + 'HABILITADO=' +
                    strToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ' WHERE ' + 'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        VL_TLoja.ConsultaA.Close;
                        VL_TLoja.ConsultaA.SQL.Text := 'SELECT ID FROM IDENTIFICACAO WHERE IDENTIFICADOR=' +
                            StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString);
                        VL_Erro := 55;
                        ...
                        begin
                            ...
                            VL_TLoja.ConsultaA.Close;
                            VL_TLoja.ConsultaA.SQL.Text := 'INSERT INTO IDENTIFICACAO(IDENTIFICADOR)VALUES(' +
                                StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString) + ') RETURNING IDENTIFICACAO.ID';
                            VL_Erro := 44;
                    ...
                    begin
                        ...
                        VL_TLoja.ConsultaA.Close;
                        VL_TLoja.ConsultaA.SQL.Text := 'SELECT ID FROM CHAVE WHERE CHAVE_COMUNICACAO=' +
                            StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString);
                        VL_Erro := 55;
                        ...
                        begin
                            ...
                            VL_TLoja.ConsultaA.Close;
                            VL_TLoja.ConsultaA.SQL.Text := 'INSERT INTO CHAVE(CHAVE_COMUNICACAO)VALUES(' +
                                StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString) + ') RETURNING CHAVE.ID';
                            VL_Erro := 44;
                            VL_Linha := '270720231734';
                            VL_TLoja.ConsultaA.Open;
                    ...
                    VL_TLoja.ConsultaA.Close;
                    VL_TLoja.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM PDV WHERE IDENTIFICADOR_PDV=' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR_PDV').AsString) + ' AND ' +
                        'LOJA_ID=' + IntToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger);
                    VL_Erro := 55;
                    ...
                    VL_TLoja.ConsultaA.SQL.Text :=
                        ...
                        StrToSQl(VL_Tabela.FieldByName('LOJA_ID').AsString) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('IP').AsString) + ',' +
                        IntToSql(VL_Tabela.FieldByName('PINPAD_ID').AsInteger) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('PINPAD_COM').AsString) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('HABILITADO').AsString) + ',' +
                        IntToSql(VL_Identificacao) + ',' +
                        IntToSql(VL_Chave) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('IDENTIFICADOR_PDV').AsString) + ') RETURNING PDV.ID';
                    VL_Erro := 44;
...
begin
    ...
    try
        try
            ...
            VL_TPdv.ConsultaA.SQL.Text := 'SELECT FIRST 1 PDV.ID FROM PDV LEFT OUTER JOIN CHAVE ON CHAVE.ID=PDV.ID WHERE CHAVE.CHAVE_COMUNICACAO=' +
                strToSql(VL_Tag);
            VL_Erro := 55;
...
begin
    ...
    try
        try
            ...
            VL_TBancoDados.ConsultaA.SQL.Text := 'SELECT PDV.ID,PDV.IDENTIFICACAO_ID,IDENTIFICACAO.IDENTIFICADOR,' +
                ' PDV.CHAVE_ID,CHAVE.CHAVE_COMUNICACAO FROM PDV ' +
                ' LEFT OUTER JOIN IDENTIFICACAO ON IDENTIFICACAO.ID=PDV.IDENTIFICACAO_ID ' +
                ' LEFT OUTER JOIN CHAVE ON CHAVE.ID=PDV.CHAVE_ID WHERE PDV.ID=' + IntToSql(VL_ID);
            VL_Erro := 55;
            ...
            begin
                ...
                if ((VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString <> VL_TBancoDados.ConsultaA.FieldByName('CHAVE_COMUNICACAO').AsString) and
                    (VL_TBancoDados.ConsultaA.FieldByName('CHAVE_COMUNICACAO').AsString <> '') and
                    (VP_Permissao <> pmC)) then
                begin
                    VL_Mensagem.Limpar;
                    VL_Mensagem.AddComando('004B', 'R');
                ...
                if ((VL_Tabela.FieldByName('IDENTIFICADOR').AsString <> VL_TBancoDados.ConsultaA.FieldByName('IDENTIFICADOR').AsString) and
                    (VL_TBancoDados.ConsultaA.FieldByName('IDENTIFICADOR').AsString <> '') and
                    (VP_Permissao <> pmC)) then
                begin
                    VL_Mensagem.Limpar;
                    VL_Mensagem.AddComando('004B', 'R');
                ...
                begin
                    ...
                    VL_TBancoDados.ConsultaB.SQL.Text := 'SELECT ID FROM IDENTIFICACAO WHERE IDENTIFICADOR=' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString);
                    VL_Erro := 55;
                    ...
                    VL_TBancoDados.ConsultaB.Close;
                    VL_TBancoDados.ConsultaB.SQL.Text := 'INSERT INTO IDENTIFICACAO(IDENTIFICADOR)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString) + ') RETURNING IDENTIFICACAO.ID';
                    VL_Erro := 44;
                ...
                begin
                    ...
                    VL_TBancoDados.ConsultaB.Close;
                    VL_TBancoDados.ConsultaB.SQL.Text := 'SELECT ID FROM CHAVE WHERE CHAVE_COMUNICACAO=' +
                        strToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString);
                    VL_Erro := 55;
                    ...
                    //INCLUI A NOVA CHAVE
                    VL_TBancoDados.ConsultaB.Close;
                    VL_TBancoDados.ConsultaB.SQL.Text := 'INSERT INTO CHAVE(CHAVE_COMUNICACAO)VALUES(''' +
                ...
                VL_TBancoDados.ConsultaA.SQL.Text := 'UPDATE PDV SET ' + 'LOJA_ID=' + intToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger) + ',' +
                    'DESCRICAO=' + strToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                    'IP=' + strToSql(VL_Tabela.FieldByName('IP').AsString) + ',' +
                    'PINPAD_ID=' + strToSql(VL_Tabela.FieldByName('PINPAD_ID').AsString) + ',' +
                    'PINPAD_COM=' + strToSql(VL_Tabela.FieldByName('PINPAD_COM').AsString) + ',' +
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    begin
                        VL_TTag.ConsultaA.Close;
                        VL_TTag.ConsultaA.SQL.Text := 'INSERT INTO TAG(' +
                            'TAG_NUMERO,' +
                            'TAG_TIPO,' +
                            'DEFINICAO,' +
                            'TIPO_DADOS,' +
                            ...
                            StrToSql(VL_Tabela.FieldByName('TAG_TIPO').AsString) + ',' +
                            StrToSql(VL_Tabela.FieldByName('DEFINICAO').AsString) + ',' +
                            StrToSql(VL_Tabela.FieldByName('TIPO_DADOS').AsString) + ',' +
                            StrToSql(VL_Tabela.FieldByName('PADRAO').AsString) + ',' +
                            StrToSql(VL_Tabela.FieldByName('OBS').AsString) + ',' +
                            StrToSql(VL_Tabela.FieldByName('DADOS').AsString) + ')';
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TPinPad.ConsultaA.SQL.Text := 'INSERT INTO PINPAD(FABRICANTE_MODELO,TAG_NUMERO)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('FABRICANTE_MODELO').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
                    VL_Erro := 44;
    ...
    try
        try
            ...
            begin
                ...
                VL_TPinPad.ConsultaA.Close;
                VL_TPinPad.ConsultaA.SQL.Text := 'UPDATE PINPAD SET ' +
                    'FABRICANTE_MODELO=' + StrToSQl(VL_Tabela.FieldByName('FABRICANTE_MODELO').AsString) + ',' +
                    'TAG_NUMERO=' + StrToSQl(VL_Tabela.FieldByName('TAG_NUMERO').AsString) +
        ...
        try
            ...
            begin
                ...
                begin
                    //verifica se existe identificador ja cadastrado
                    VL_TBancoDados.ConsultaA.Close;
                    VL_TBancoDados.ConsultaA.SQL.Text := 'SELECT ID FROM IDENTIFICACAO WHERE IDENTIFICADOR=' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString);
                    VL_Erro := 55;
                    ...
                    begin
                        //insere dados na tabela identificacao
                        VL_TBancoDados.ConsultaA.Close;
                        VL_TBancoDados.ConsultaA.SQL.Text := 'INSERT INTO IDENTIFICACAO(IDENTIFICADOR)VALUES(' +
                            StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString) + ') RETURNING IDENTIFICACAO.ID';
                        VL_Erro := 44;
                        VL_Linha := '310720231042';
                        VL_TBancoDados.ConsultaA.ExecSQL;
                    ...
                    begin
                        //verifica se existe chave ja cadastrado
                        VL_TBancoDados.ConsultaA.Close;
                        VL_TBancoDados.ConsultaA.SQL.Text := 'SELECT ID FROM CHAVE WHERE CHAVE_COMUNICACAO=' +
                            StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString);
                        VL_Erro := 55;
                        ...
                        begin
                            //insere dados na tabela chave
                            VL_TBancoDados.ConsultaA.Close;
                            VL_TBancoDados.ConsultaA.SQL.Text := 'INSERT INTO CHAVE(CHAVE_COMUNICACAO)VALUES(' +
                                StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString) + ') RETURNING CHAVE.ID';
                            VL_Erro := 44;
                    ...
                    VL_TBancoDados.ConsultaA.Close;
                    VL_TBancoDados.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM CONFIGURADOR WHERE CHAVE_ID=' +
                        IntToSql(VL_Chave);
                    VL_Erro := 55;
                    ...
                    VL_TBancoDados.ConsultaA.SQL.Text := 'INSERT INTO CONFIGURADOR(DESCRICAO,IP,CHAVE_ID,IDENTIFICACAO_ID,SENHA_CONFIGURADOR,' +
                        ...
                        ',' + StrToSql(VL_Tabela.FieldByName('IP').AsString) + ',' + IntToSql(VL_Chave) + ',' +
                        IntToSql(VL_Identificacao) + ',' + StrToSql(VL_Tabela.FieldByName('SENHA_CONFIGURADOR').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('SENHA_ADMINISTRADOR').AsString) + ',' + StrToSql(VL_Tabela.FieldByName(
    ...
    try
        try
            ...
            begin
                ...
                //COMEÇA A ALTERAÇÃO
                VL_TConfigurador.ConsultaA.Close;
                VL_TConfigurador.ConsultaA.SQL.Text := 'UPDATE CONFIGURADOR SET ' + 'DESCRICAO=' + StrToSql(VL_Tabela.FieldByName(
                    'DESCRICAO').AsString) + ',' + 'IP=' + StrToSql(VL_Tabela.FieldByName('IP').AsString) + ',' + 'CHAVE=' +
                    StrToSql(VL_Tabela.FieldByName('CHAVE').AsString) + ',' + 'SENHA_CONFIGURADOR=' +
                    StrToSql(VL_Tabela.FieldByName('SENHA_CONFIGURADOR').AsString) +
                    ',' + 'SENHA_ADMINISTRADOR=' + StrToSql(VL_Tabela.FieldByName('SENHA_ADMINISTRADOR').AsString) + ',' +
                    'SENHA_USUARIO=' + StrToSql(VL_Tabela.FieldByName('SENHA_USUARIO').AsString) + ' WHERE ' + 'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
...
begin
    ...
    try
        try
            ...
            VL_TConfigurador.ConsultaA.Close;
            VL_TConfigurador.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM CONFIGURADOR WHERE CHAVE=' + StrToSql(VL_Tag);
            VL_Erro := 55;
            ...
            begin
                if VL_TConfigurador.ZConexao.Connected then
                    if VL_TConfigurador.ZConexao.InTransaction then
                        VL_TConfigurador.ZConexao.Rollback;
                GravaLog(F_ArquivoLog, 0, '0059', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
        ...
        try
            ...
            begin
                if VL_TBancoDados.ZConexao.Connected then
                    if VL_TBancoDados.ZConexao.InTransaction then
                        VL_TBancoDados.ZConexao.Rollback;
                GravaLog(F_ArquivoLog, 0, '0064', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
...
begin
    ...
    try
        try
            ...
            on E: Exception do
            begin
                GravaLog(F_ArquivoLog, 0, '0067', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
        ...
        try
            ...
            begin
                if VL_TPinPad.ZConexao.Connected then
                    if VL_TPinPad.ZConexao.InTransaction then
                        VL_TPinPad.ZConexao.Rollback;
                GravaLog(F_ArquivoLog, 0, '006A', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
            ...
            try
                ...
                begin
                    ...
                    VL_TTabela.ConsultaA.SQL.Text :=
                        'SELECT L.*, CASE WHEN EXISTS(SELECT ML.ID FROM MULTILOJA ML WHERE ML.LOJA_ID=L.ID)' +
                        ' THEN ''T'' ELSE ''F'' END AS MULT FROM LOJA L WHERE ((L.ID=' + IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) +
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT M.*,L.DOC,L.RAZAO,L.FANTASIA FROM MULTILOJA M ' +
                        ' LEFT OUTER JOIN LOJA L ON L.ID=M.LOJA_ID WHERE ((M.ID=' + IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) +
                        ' is not null) and ' + '((' + IntToSql(VL_Dados) + ' is null) or (' + IntToSql(VL_Dados) + '=0)))';
                    VL_TTabela.ConsultaA.Open;
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT T.*,CAST(T.DADOS AS VARCHAR(500)) AS DADOS_F FROM TAG T WHERE ((ID=' +
                        IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) + ' is not null) and ' +
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT AD.*,T.DEFINICAO FROM ADQUIRENTE AD ' +
                        ' LEFT OUTER JOIN TAG T ON T.TAG_NUMERO=AD.TAG_NUMERO' +
                        ' WHERE ((AD.ID=' +
                        IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) + ' is not null) and ' + '((' + IntToSql(VL_Dados) +
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT * FROM PINPAD WHERE ((ID=' + IntToSql(VL_Dados) + ') or (' +
                        IntToSql(VL_Dados) + ' is not null) and ((' +
                        IntToSql(VL_Dados) + ' is null) or (' + IntToSql(VL_Dados) + '=0)))';
                    VL_TTabela.ConsultaA.Open;
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT PDV.*,IDENTIFICACAO.IDENTIFICADOR,CHAVE.CHAVE_COMUNICACAO' +
                        ' FROM PDV' +
                        ' LEFT OUTER JOIN CHAVE ON CHAVE.ID=PDV.CHAVE_ID' +
                        ' LEFT OUTER JOIN IDENTIFICACAO ON IDENTIFICACAO.ID=PDV.IDENTIFICACAO_ID' +
                        ' WHERE ((PDV.ID=' + IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) + ' is not null) and ((' +
                        IntToSql(VL_Dados) + ' is null) or (' + IntToSql(VL_Dados) + '=0)))';
                    VL_TTabela.ConsultaA.Open;
                    ...
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT P.*,M.DESCRICAO AS MODULO,MC.DESCRICAO AS MODULO_CONF,T.TAG_NUMERO,T.DEFINICAO FROM ' +
                        ...
                        'WHERE P.PDV_ID=' + IntToSql(VL_Dados);
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT * FROM CONFIGURADOR WHERE ((ID=' + IntToSql(VL_Dados) + ') or (' + IntToSql(VL_Dados) +
                        ' is not null) and ((' + IntToSql(VL_Dados) + ' is null) or (' + IntToSql(VL_Dados) + '=0)))';
                    VL_TTabela.ConsultaA.Open;
                    VL_Tag := ZQueryToStrRxMemData(VL_TTabela.ConsultaA);
                ...
                begin
                    VL_TTabela.ConsultaA.Close;
                    VL_TTabela.ConsultaA.SQL.Text := 'SELECT * FROM MODULO WHERE ((ID=' + IntToStr(VL_Dados) + ') or (' +
                        IntToStr(VL_Dados) + ' is not null) and ' +
                    ...
                    VL_TTabela.ConsultaA.SQL.Text :=
                        ...
                        ' LEFT OUTER JOIN ADQUIRENTE AD ON AD.ID=MC.ADQUIRENTE_ID' +
                        ' LEFT OUTER JOIN CHAVE ON CHAVE.ID=MC.CHAVE_ID' +
                        ' LEFT OUTER JOIN IDENTIFICACAO ON IDENTIFICACAO.ID=MC.IDENTIFICACAO_ID' +
                        ' WHERE ' +
...
begin
    ...
    try
        try
            ...
            VL_TModuloConf.ConsultaA.SQL.Text := 'SELECT FIRST 1 MC.ID FROM MODULO_CONF MC INNER JOIN CHAVE C ' +
                ' ON C.ID = MC.CHAVE_ID ' +
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '0071', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
...
begin
    ...
    try
        try
            ...
            //verifica se existe o id pra modificação
            VL_TBancoDados.ConsultaA.Close;
            VL_TBancoDados.ConsultaA.SQL.Text := 'SELECT MC.ID,MC.IDENTIFICACAO_ID,IDENTIFICACAO.IDENTIFICADOR,' +
                ' MC.CHAVE_ID,CHAVE_COMUNICACAO FROM MODULO_CONF MC ' +
                ' LEFT OUTER JOIN IDENTIFICACAO ON IDENTIFICACAO.ID=MC.IDENTIFICACAO_ID ' +
                ' LEFT OUTER JOIN CHAVE ON CHAVE.ID=MC.CHAVE_ID WHERE MC.ID=' + IntToSql(VL_ID);
            VL_Erro := 55;
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '0072', 'cadastro', VL_Linha, 'registro numero ' + IntToStr(VL_ID) +
                    ' não localizado para alteração na tabela modulo_conf', '', VL_Erro, 1);
                Exit;
            end;
            //COMEÇA A ALTERAÇÃO
            if VL_Tabela.Locate('ID', VL_ID, []) then
            begin
                ...
                begin
                    ...
                    //exclui o identificador do banco
                    VL_TBancoDados.ConsultaB.Close;
                    VL_TBancoDados.ConsultaB.SQL.Text := 'DELETE FROM IDENTIFICACAO WHERE ID=' +
                        IntToSql(VL_TBancoDados.ConsultaA.FieldByName('IDENTIFICACAO_ID').AsInteger);
                    VL_Erro := 82;
                ...
                //ALTERA
                VL_TBancoDados.ConsultaA.Close;
                VL_TBancoDados.ConsultaA.SQL.Text := 'UPDATE MODULO_CONF SET ' +
                    'DESCRICAO=' + StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                    'CHAVE_ID=' + IntToSql(VL_CHAVE) + ',' +
                    'IDENTIFICACAO_ID=' + IntToSql(VL_Identificador) + ',' +
                    'ADQUIRENTE_ID=' + StrToSql(VL_Tabela.FieldByName('ADQUIRENTE_ID').AsString) + ',' +
                    'SERVICO_HOST=' + StrToSql(VL_Tabela.FieldByName('SERVICO_HOST').AsString) + ',' +
                    'SERVICO_PORTA=' + StrToSql(VL_Tabela.FieldByName('SERVICO_PORTA').AsString) + ',' +
                    'CAIXA_HOST=' + StrToSql(VL_Tabela.FieldByName('CAIXA_HOST').AsString) + ',' +
                    'CAIXA_PORTA=' + StrToSql(VL_Tabela.FieldByName('CAIXA_PORTA').AsString) + ',' +
                    'BIN_ESTATICO=' + StrToSql(VL_Tabela.FieldByName('BIN_ESTATICO').AsString) + ',' +
                    'MENU_ESTATICO=' + StrToSql(VL_Tabela.FieldByName('MENU_ESTATICO').AsString) + ',' +
                    'MENU_ESTATICO_OPERACIONAL=' + StrToSql(VL_Tabela.FieldByName('MENU_ESTATICO_OPERACIONAL').AsString) + ',' +
                    'HABILITADO=' + StrToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ' WHERE ' +
                    'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '0072', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM MODULO_CONF WHERE MODULO_ID=' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_ID').AsInteger) + ' AND ADQUIRENTE_ID=' +
                        IntToSql(VL_Tabela.FieldByName('ADQUIRENTE_ID').AsInteger) + ' AND IDENTIFICACAO_ID=' +
                        IntToSql(VL_Tabela.FieldByName('IDENTIFICACAO_ID').AsInteger);
                    VL_Erro := 55;
                    ...
                    //TESTA CAMPOS OBRIGATORIOS
                    if ((length(VL_Tabela.FieldByName('IDENTIFICADOR').AsString) = 0) or
                        (length(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString) = 0) or
                    ...
                    //verifica se existe chave ja cadastrado
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'SELECT ID FROM CHAVE WHERE CHAVE_COMUNICACAO=' +
                        StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString);
                    VL_Erro := 55;
                    VL_Linha := '270720231732';
                    VL_TModuloConf.ConsultaA.Open;
                    ...
                    //insere dados na tabela chave
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'INSERT INTO CHAVE(CHAVE_COMUNICACAO)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('CHAVE_COMUNICACAO').AsString) + ') RETURNING CHAVE.ID';
                    VL_Erro := 44;
                    VL_Linha := '270720231734';
                    VL_TModuloConf.ConsultaA.Open;
                    ...
                    //verifica se existe chave ja cadastrado
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'SELECT ID FROM IDENTIFICACAO WHERE IDENTIFICADOR=' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString);
                    VL_Erro := 55;
                    VL_Linha := '270720231732';
                    VL_TModuloConf.ConsultaA.Open;
                    ...
                    //insere dados na tabela chave
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'INSERT INTO IDENTIFICACAO(IDENTIFICADOR)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('IDENTIFICADOR').AsString) + ') RETURNING ID';
                    VL_Erro := 44;
                    VL_Linha := '270720231734';
                    VL_TModuloConf.ConsultaA.Open;
                    ...
                    //COMEÇA A INCLUSÃO
                    VL_TModuloConf.ConsultaA.Close;
                    VL_TModuloConf.ConsultaA.SQL.Text := 'INSERT INTO MODULO_CONF(' +
                        'MODULO_ID,' +
                        'ADQUIRENTE_ID,' +
                        'SERVICO_HOST,' +
                        'SERVICO_PORTA,' +
                        ...
                        'HABILITADO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_ID').AsInteger) + ',' +
                        IntToSql(VL_Tabela.FieldByName('ADQUIRENTE_ID').AsInteger) + ',' +
                        StrToSql(VL_Tabela.FieldByName('SERVICO_HOST').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('SERVICO_PORTA').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('CAIXA_HOST').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('CAIXA_PORTA').AsString) + ',' +
                        IntToSql(VL_Chave_ID) + ',' +
                        IntToSql(VL_Identificacao_ID) + ',' +
                        StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('BIN_ESTATICO').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('MENU_ESTATICO').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('MENU_ESTATICO_OPERACIONAL').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ')' +
                        ' RETURNING ID ';
                    VL_Erro := 44;
            ...
            begin
                if VL_TModuloConf.ZConexao.Connected then
                    if VL_TModuloConf.ZConexao.InTransaction then
                        VL_TModuloConf.ZConexao.Rollback;
                GravaLog(F_ArquivoLog, 0, '0073', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TModulo.ConsultaA.Close;
                    VL_TModulo.ConsultaA.SQL.Text := 'INSERT INTO MODULO(' +
                        'DESCRICAO,' +
                        'TAG_NUMERO)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '0074', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
    ...
    try
        try
            ...
            begin
                ...
                //COMEÇA A ALTERAÇÃO
                VL_TModulo.ConsultaA.Close;
                VL_TModulo.ConsultaA.SQL.Text := 'UPDATE MODULO SET ' +
                    'DESCRICAO=' + StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                    'TAG_NUMERO=' + StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ' WHERE ' +
                    'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
            ...
            begin
                if VL_TModulo.ZConexao.Connected then
                    if VL_TModulo.ZConexao.InTransaction then
                        VL_TModulo.ZConexao.Rollback;
                GravaLog(F_ArquivoLog, 0, '0075', 'cadastro', VL_Linha, 'erro inesperado na classe:' + e.ClassName +
                    '/ mensagem:' + e.Message, '', VL_Erro, 1);
            end;
        end;
    finally
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TBin.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID,MODULO_CONF_ID FROM BIN WHERE (IIN=' +
                        StrToSql(VL_Tabela.FieldByName('IIN').AsString) + ')';
                    VL_Erro := 55;
                    ...
                    VL_TBin.ConsultaA.Close;
                    VL_TBin.ConsultaA.SQL.Text := 'INSERT INTO BIN(' +
                        'MODULO_CONF_ID,' +
                        'IIN)VALUES(' +
                        StrToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsString) + ',' +
                        StrToSql(VL_Tabela.FieldByName('IIN').AsString) + ')';
                    VL_Erro := 44;
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    //COMEÇA A INCLUSÃO
                    VL_TModuloConfFuncao.ConsultaA.Close;
                    VL_TModuloConfFuncao.ConsultaA.SQL.Text := 'INSERT INTO MODULO_CONF_FUNCAO(' +
                        'MODULO_CONF_ID,' +
                        'TAG_NUMERO)VALUES(' +
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TModuloFunc.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM MODULO_FUNCAO WHERE MODULO_ID=' +
                        intToSql(VL_Tabela.FieldByName('MODULO_ID').AsInteger) + ' AND TAG_NUMERO=' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //COMEÇA A INSERIR
                    VL_TModuloFunc.ConsultaA.Close;
                    VL_TModuloFunc.ConsultaA.SQL.Text := 'INSERT INTO MODULO_FUNCAO(' +
                        'MODULO_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_ID').AsInteger) + ',' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
    ...
    try
        try
            ...
            begin
                ...
                VL_TModuloFunc.ConsultaA.Close;
                VL_TModuloFunc.ConsultaA.SQL.Text := 'DELETE FROM MODULO_FUNCAO WHERE ' +
                    'ID=' + IntToSql(VL_MODULO_FUNCAO_ID);
                VL_Erro := 46;
    ...
    try
        try
            ...
            VL_TModulo_Conf_Funcao.ConsultaA.SQL.Text := 'SELECT MODULO_CONF_FUNCAO.*,MODULO_CONF.MODULO_ID FROM MODULO_CONF_FUNCAO ' +
                'INNER join MODULO_CONF  on modulo_conf.ID=MODULO_CONF_FUNCAO.MODULO_CONF_ID WHERE MODULO_CONF_FUNCAO.ID=' +
                IntToSql(VL_Modulo_Conf_Funcao_ID);
            VL_Erro := 55;
...
begin
    ...
    try
        try
            ...
            VL_TMultiLoja_Modulo_Conf_Funcao.ConsultaA.SQL.Text := 'SELECT * FROM MULTILOJA_MODULO_CONF_FUNCAO WHERE ID=' +
                IntToStr(VL_MultiLoja_Modulo_Conf_Funcao_ID);
            VL_Erro := 55;
            ...
            begin
                ...
                VL_TMultiLoja_Modulo_Conf_Funcao.ConsultaA.Close;
                VL_TMultiLoja_Modulo_Conf_Funcao.ConsultaA.SQL.Text := 'DELETE FROM MULTILOJA_MODULO_CONF_FUNCAO WHERE ' +
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '0088', 'CADASTRO',
                    ...
                    IntToStr(VL_MultiLoja_Modulo_Conf_Funcao_ID), '', VL_Erro, 1);
                exit;
            end;
            VL_Mensagem.Limpar;
            VL_Mensagem.AddComando('0088', 'R');
    ...
    try
        try
            ...
            begin
                ...
                VL_TModulo_Conf_Funcao.ConsultaA.Close;
                VL_TModulo_Conf_Funcao.ConsultaA.SQL.Text := 'DELETE FROM MODULO_CONF_FUNCAO WHERE ' +
                    'ID=' + IntToSql(VL_Modulo_Conf_Funcao_ID);
                VL_Erro := 82;
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '008A', 'CADASTRO',
                    ...
                    IntToStr(VL_Modulo_Conf_Funcao_ID), '', VL_Erro, 1);
            end;
        except
            on E: Exception do
            begin
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TMultLojaModulo.ConsultaA.Close;
                    VL_TMultLojaModulo.ConsultaA.SQL.Text := 'INSERT INTO MULTILOJA_MODULO_CONF(' +
                        'MULTILOJA_ID,' +
                        'HABILITADO,' +
                    ...
                    VL_TMultLojaModulo.ConsultaA.Close;
                    VL_TMultLojaModulo.ConsultaA.SQL.Text := 'SELECT * FROM MULTILOJA_MODULO_CONF WHERE MODULO_CONF_ID=' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsInteger);
                    VL_Erro := 55;
    ...
    try
        try
            ...
            begin
                ...
                VL_TMultLoja_Modulo.ConsultaA.Close;
                VL_TMultLoja_Modulo.ConsultaA.SQL.Text := 'UPDATE MULTILOJA_MODULO_CONF SET ' + 'HABILITADO=' +
                    strToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ',' +
            ...
            begin
                ...
                begin
                    ...
                    VL_TLojaModuloConfFuncao.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM LOJA_MODULO_CONF_FUNCAO WHERE LOJA_MODULO_CONF_ID=' +
                        intToSql(VL_Tabela.FieldByName('LOJA_MODULO_CONF_ID').AsInteger) + ' AND TAG_NUMERO=' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //COMEÇA A INSERIR
                    VL_TLojaModuloConfFuncao.ConsultaA.Close;
                    VL_TLojaModuloConfFuncao.ConsultaA.SQL.Text := 'INSERT INTO LOJA_MODULO_CONF_FUNCAO(' +
                        'LOJA_MODULO_CONF_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('LOJA_MODULO_CONF_ID').AsInteger) + ',' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
                    VL_Erro := 44;
                    ...
                    VL_TLojaModuloConfFuncao.ConsultaA.SQL.Text := 'SELECT * FROM LOJA_MODULO_CONF_FUNCAO WHERE LOJA_MODULO_CONF_ID=' +
                        IntToSql(VL_Tabela.FieldByName(
                        'LOJA_MODULO_CONF_ID').AsInteger) + ' AND TAG_NUMERO=' + strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
            ...
            begin
                ...
                begin
                    ...
                    VL_TMultLoja_Funcao.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM MULTILOJA_FUNCAO WHERE MULTILOJA_ID=' +
                        IntToSql(VL_Tabela.FieldByName('MULTILOJA_ID').AsInteger) + ' AND TAG_NUMERO=' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //COMEÇA A INCLUSAO
                    VL_TMultLoja_Funcao.ConsultaA.Close;
                    VL_TMultLoja_Funcao.ConsultaA.SQL.Text := 'INSERT INTO MULTILOJA_FUNCAO(' +
                        'MULTILOJA_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('MULTILOJA_ID').AsInteger) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
    ...
    try
        try
            ...
            begin
                ...
                VL_TMultLoja_Funcao.ConsultaA.Close;
                VL_TMultLoja_Funcao.ConsultaA.SQL.Text := 'UPDATE MULTILOJA_FUNCAO SET HABILITADO=' + StrToSql(VL_HABILITADO) + ' WHERE ' +
                    'ID=' + IntToSql(VL_MultLoja_Funcao_ID);
                VL_Erro := 46;
    ...
    try
        try
            ...
            begin
                //exclui o modulo_func
                VL_TMultLoja_Funcao.ConsultaA.Close;
                VL_TMultLoja_Funcao.ConsultaA.SQL.Text := 'DELETE FROM MULTILOJA_FUNCAO WHERE ' +
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TLoja_Funcao.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM LOJA_FUNCAO WHERE LOJA_ID=' +
                        IntToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger) + ' AND TAG_NUMERO=' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //FAZ A INCLUSÃO
                    VL_TLoja_Funcao.ConsultaA.Close;
                    VL_TLoja_Funcao.ConsultaA.SQL.Text := 'INSERT INTO LOJA_FUNCAO(' +
                        'LOJA_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger) + ',' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
                    VL_Erro := 44;
                    ...
                    VL_TLoja_Funcao.ConsultaA.Close;
                    VL_TLoja_Funcao.ConsultaA.SQL.Text := 'SELECT * FROM LOJA_FUNCAO WHERE LOJA_ID=' + intToSql(VL_Tabela.FieldByName(
                        'LOJA_ID').AsInteger) + ' AND TAG_NUMERO=' + strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
    ...
    try
        try
            ...
            begin
                //ALTERA o modulo_func
                VL_TLoja_Funcao.ConsultaA.Close;
                VL_TLoja_Funcao.ConsultaA.SQL.Text := 'UPDATE LOJA_FUNCAO SET HABILITADO=' + strToSql(VL_HABILITADO) + ' WHERE ' +
                    'ID=' + IntToSql(VL_Loja_Funcao_ID);
                VL_Erro := 46;
    ...
    try
        try
            ...
            begin
                //exclui o modulo_func
                VL_TLoja_Funcao.ConsultaA.Close;
                VL_TLoja_Funcao.ConsultaA.SQL.Text := 'DELETE FROM LOJA_FUNCAO WHERE ' +
                    'ID=' + IntToSql(VL_Loja_Funcao_ID);
                VL_Erro := 82;
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TLojaModulo.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM LOJA_MODULO_CONF WHERE MODULO_CONF_ID=' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsInteger) + ' AND LOJA_ID=' +
                        IntToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger);
                    VL_Erro := 55;
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '00AE', 'cadastro', VL_Linha,
                            ...
                            VL_Tabela.FieldByName('LOJA_ID').AsString + ')', '', VL_Erro, 1);
                        Exit;
                    end;
                    //COMEÇA A INSERIR
                    VL_TLojaModulo.ConsultaA.Close;
                    VL_TLojaModulo.ConsultaA.SQL.Text := 'INSERT INTO LOJA_MODULO_CONF(' +
                        'LOJA_ID,' +
                        'HABILITADO,' +
                        'MODULO_CONF_ID,' +
                        'CODIGO)VALUES(' +
                    ...
                    VL_TLojaModulo.ConsultaA.SQL.Text := 'SELECT * FROM LOJA_MODULO_CONF WHERE MODULO_CONF_ID=' +
                        IntToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsInteger) + ' AND LOJA_ID=' +
                        IntToSql(VL_Tabela.FieldByName('LOJA_ID').AsInteger);
                    VL_Erro := 55;
        ...
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '00B0', 'cadastro', VL_Linha, 'não encontrado o registro numero:' +
                    IntToStr(VL_MultiLoja_Modulo_Conf_Funcao_ID) + ' na tabela multiloja_modulo_conf_funcao', '', VL_Erro, 1);
                Exit;
            end;
            VL_Mensagem.Limpar;
            VL_Mensagem.AddComando('00B0', 'R');
    ...
    try
        try
            ...
            begin
                ...
                VL_TLoja_Modulo.ConsultaA.Close;
                VL_TLoja_Modulo.ConsultaA.SQL.Text := 'UPDATE LOJA_MODULO_CONF SET ' + 'HABILITADO=' +
                    strToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ',' +
                    'MODULO_CONF_ID=' + IntToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsInteger) + ',' + 'CODIGO=' +
                    strToSql(VL_Tabela.FieldByName('CODIGO').AsString) + ' WHERE ' + 'ID=' + IntToStr(VL_ID);
                VL_Erro := 46;
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TPinPad_Funcao.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM PINPAD_FUNCAO WHERE PINPAD_ID=' +
                        StrToSql(VL_Tabela.FieldByName('PINPAD_ID').AsString) + ' AND TAG_NUMERO=' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //COMEÇA A INCLUSÃO
                    VL_TPinPad_Funcao.ConsultaA.Close;
                    VL_TPinPad_Funcao.ConsultaA.SQL.Text := 'INSERT INTO PINPAD_FUNCAO(' +
                        'PINPAD_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('PINPAD_ID').AsInteger) + ',' +
                        StrToSQl(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
    ...
    try
        try
            ...
            begin
                ...
                VL_TPinPad_Funcao.ConsultaA.Close;
                VL_TPinPad_Funcao.ConsultaA.SQL.Text := 'UPDATE PINPAD_FUNCAO SET HABILITADO=' + StrToSql(VL_HABILITADO) + ' WHERE ' +
                    'ID=' + IntToSql(VL_PinPad_Funcao_ID);
                VL_Erro := 46;
    ...
    try
        try
            ...
            begin
                ...
                VL_TPinPad_Funcao.ConsultaA.Close;
                VL_TPinPad_Funcao.ConsultaA.SQL.Text := 'DELETE FROM PINPAD_FUNCAO WHERE ' +
                    'ID=' + IntToSql(VL_PinPad_Funcao_ID);
                VL_Erro := 82;
    ...
    try
        try
            ...
            begin
                ...
                //ALTERA o modulo_conf_funcao
                VL_TModulo_Funcao.ConsultaA.Close;
                VL_TModulo_Funcao.ConsultaA.SQL.Text := 'UPDATE MODULO_FUNCAO SET HABILITADO=' + strToSql(VL_HABILITADO) + ' WHERE ' +
                    'ID=' + IntToSql(VL_Modulo_Funcao_ID);
                VL_Erro := 46;
        ...
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '00BA', 'cadastro', VL_Linha, 'não localizado na tabela modulo_conf o registro numero:' +
                    IntToStr(VL_Modulo_Conf_ID), '', VL_Erro, 1);
                Exit;
            end;
        except
            on E: Exception do
        ...
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '00BB', 'cadastro', VL_Linha, 'não localizado na tabela configurador o registro numero:' +
                    IntToStr(VL_Configurador_ID), '', VL_Erro, 1);
                Exit;
            end;
        except
            on E: Exception do
        ...
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '002B', 'cadastro', VL_Linha, 'não localizado na tabela modulo o registro numero:' +
                    IntToStr(VL_Modulo_ID), '', VL_Erro, 1);
                Exit;
            end;
        except
            on E: Exception do
        ...
        try
            ...
            begin
                ...
                begin
                    ...
                    VL_TPdv_Funcao.ConsultaA.SQL.Text := 'SELECT FIRST 1 ID FROM PDV_FUNCAO WHERE PDV_ID=' +
                        StrToSql(VL_Tabela.FieldByName('PDV_ID').AsString) + ' AND TAG_NUMERO=' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //COMEÇA A INCLUSÃO
                    VL_TPdv_Funcao.ConsultaA.Close;
                    VL_TPdv_Funcao.ConsultaA.SQL.Text := 'INSERT INTO PDV_FUNCAO(' +
                        'PDV_ID,' +
                        'TAG_NUMERO)VALUES(' +
                    ...
                    VL_TPdv_Funcao.ConsultaA.Close;
                    VL_TPdv_Funcao.ConsultaA.SQL.Text := 'SELECT * FROM PDV_FUNCAO WHERE PDV_ID=' +
                        StrToSql(VL_Tabela.FieldByName('PDV_ID').AsString) + ' AND TAG_NUMERO=' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
    ...
    try
        try
            ...
            begin
                //ALTERA o PINPAD_FUNC
                VL_TPdv_Funcao.ConsultaA.Close;
                VL_TPdv_Funcao.ConsultaA.SQL.Text := 'UPDATE PDV_FUNCAO SET HABILITADO=' + StrToSql(VL_HABILITADO) + ' WHERE ' +
                    'ID=' + IntToSql(VL_Pdv_Funcao_ID);
                VL_Erro := 46;
    ...
    try
        try
            ...
            begin
                //exclui o pdv_funcao
                VL_TPdv_Funcao.ConsultaA.Close;
                VL_TPdv_Funcao.ConsultaA.SQL.Text := 'DELETE FROM PDV_FUNCAO WHERE ' +
                    'ID=' + IntToSql(VL_Pdv_Funcao_ID);
                VL_Erro := 82;
                ...
                begin
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '00C8', 'cadastro', VL_Linha,
                            ...
                            VL_Tabela.FieldByName('PDV_ID').AsString + ')', '', VL_Erro, 1);
                        Exit;
                    end;

                    VL_TPdvModulo.ConsultaA.Close;
                    VL_TPdvModulo.ConsultaA.SQL.Text := 'INSERT INTO PDV_MODULO_CONF(' +
                        'PDV_ID,' +
                        'TAG_NUMERO,' +
                        'CODIGO,' +
                        'HABILITADO,' +
                    ...
                    VL_TPdvModulo.ConsultaA.Close;
                    VL_TPdvModulo.ConsultaA.SQL.Text := 'SELECT * FROM PDV_MODULO_CONF WHERE MODULO_CONF_ID=' +
                        StrToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsString) + ' AND TAG_NUMERO=' +
                        StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
            ...
            begin
                ...
                begin
                    ...
                    VL_TMultiLojaModuloConfFuncao.ConsultaA.SQL.Text :=
                        'SELECT FIRST 1 ID FROM MULTILOJA_MODULO_CONF_FUNCAO WHERE MULTILOJA_MODULO_CONF_ID=' +
                        strToSql(VL_Tabela.FieldByName('MULTILOJA_MODULO_CONF_ID').AsString) + ' AND TAG_NUMERO=' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
                    ...
                    //começa a inclusão
                    VL_TMultiLojaModuloConfFuncao.ConsultaA.Close;
                    VL_TMultiLojaModuloConfFuncao.ConsultaA.SQL.Text := 'INSERT INTO MULTILOJA_MODULO_CONF_FUNCAO(' +
                        'MULTILOJA_MODULO_CONF_ID,' +
                        'TAG_NUMERO)VALUES(' +
                        IntToSql(VL_Tabela.FieldByName('MULTILOJA_MODULO_CONF_ID').AsInteger) + ',' +
                        strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ')';
                    VL_Erro := 44;
                    ...
                    VL_TMultiLojaModuloConfFuncao.ConsultaA.SQL.Text := 'SELECT * FROM MULTILOJA_MODULO_CONF_FUNCAO WHERE MULTILOJA_MODULO_CONF_ID=' +
                        intToSql(VL_Tabela.FieldByName(
                        'MULTILOJA_MODULO_CONF_ID').AsInteger) + ' AND TAG_NUMERO=' + strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString);
                    VL_Erro := 55;
    ...
    try
        try
            ...
            begin
                ...
                //COMEÇA A ALTERAÇÃO
                VL_TPdv_Modulo.ConsultaA.Close;
                VL_TPdv_Modulo.ConsultaA.SQL.Text := 'UPDATE PDV_MODULO_CONF SET ' +
                    'TAG_NUMERO=' + strToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) + ',' +
                    'CODIGO=' + strToSQl(VL_Tabela.FieldByName('CODIGO').AsString) + ',' +
                    'HABILITADO=' + strToSql(VL_Tabela.FieldByName('HABILITADO').AsString) + ',' +
                    'MODULO_CONF_ID=' + IntToSql(VL_Tabela.FieldByName('MODULO_CONF_ID').AsInteger) + ' WHERE ' +
                    'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
...
begin
    ...
    try
        try
            ...
            if VL_Tabela.Locate('ID', VL_ID, []) then
            begin
                if ((VL_Tabela.FieldByName('ID').AsInteger <> VL_TTag.ConsultaA.FieldByName('ID').AsInteger) or
                    (VL_Tabela.FieldByName('TAG_NUMERO').AsString <> VL_TTag.ConsultaA.FieldByName('TAG_NUMERO').AsString)) then
                begin
                    VL_Mensagem.Limpar;
                    VL_Mensagem.AddComando('00DB', 'R');
                    VL_Mensagem.AddTag('004D', '49'); //dados chaves não podem sofer alteração
                ...
                VL_TTag.ConsultaA.Close;
                VL_TTag.ConsultaA.SQL.Text := 'UPDATE TAG SET ' +
            ...
            begin
                ...
                begin
                    ...
                    begin
                        ...
                        GravaLog(F_ArquivoLog, 0, '00DE', 'CADASTRO', VL_Linha, 'campos obrigatórios vazio Tag na ' +
                            'tabela Adquirente', '', VL_Erro, 1);
                        Exit;
                    end;
                    ...
                    begin
                        VL_TBancoDados.ConsultaA.Close;
                        VL_TBancoDados.ConsultaA.SQL.Text := 'INSERT INTO ADQUIRENTE(' +
                            'DESCRICAO,' +
                            'TAG_NUMERO,' +
                            'CONTATO) VALUES(' +
                            StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString, False, 100) + ',' +
                            StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString, False, 4) + ',' +
                            StrToSql(VL_Tabela.FieldByName('CONTATO').AsString, False, 500) + ')' +
                            ' RETURNING ID ';
                        VL_Erro := 44;
    ...
    try
        try
            ...
            begin
                ...
                VL_TBancoDados.ConsultaA.Close;
                VL_TBancoDados.ConsultaA.SQL.Text := 'UPDATE ADQUIRENTE SET ' +
                    'DESCRICAO=' + StrToSql(VL_Tabela.FieldByName('DESCRICAO').AsString) + ',' +
                    'CONTATO=' + StrToSql(VL_Tabela.FieldByName('CONTATO').AsString) + ',' +
                    'TAG_NUMERO=' + StrToSql(VL_Tabela.FieldByName('TAG_NUMERO').AsString) +
                    ' WHERE ' +
                    'ID=' + IntToSql(VL_ID);
                VL_Erro := 46;
        ...
        try
            ...
            begin
                ...
                GravaLog(F_ArquivoLog, 0, '00FA', 'cadastro', VL_Linha, 'Nenhuma Loja cadastrado com este ID:' +
                    IntToStr(VL_LojaID) + ' na tabela de Loja', '', VL_Erro, 1);
                Exit;
            end
            else
            begin
                VL_TLoja.ConsultaA.Close;
                VL_TLoja.ConsultaA.SQL.Text := 'UPDATE LOJA SET ' +
                    ' MULTILOJA_ID=' + IntToSql(VL_MultiLojaID) +
                    ' WHERE ' +
            ...
            begin
                ...
                begin
                    ...
                    GravaLog(F_ArquivoLog, 0, '00FB', 'cadastro', VL_Linha, 'Multiloja informada (' + IntToStr(VL_MultiLojaID) +
                        ') diferente da cadastrada na Loja (' + VL_TLoja.ConsultaA.FieldByName('MULTILOJA_ID').AsString +
                        ') na tabela de Loja', '', VL_Erro, 1);
                    Exit;
                end
                else
                begin
