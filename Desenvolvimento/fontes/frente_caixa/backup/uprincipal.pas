...
const
    C_VersaoConciliacao: string = '1.0.0';
...
begin
    ...
    begin                                                             // DEVE TESTAR TODOS OS POSSIVEIS DADOS SOLICITADOS PARA RESPONDER A OPERADORA
        ...
        begin
            ...
            F_MensagemAddComando(VL_TagConciliacao, '0118', 'CONCILIACAO'); // indice que e uma tabela de dados
            ...
            F_MensagemAddTag(VL_Resposta, '0117', VL_DadosEnviados); // DADOS DA CONCILIACAO
...
begin
    ...
    // SOLICITA APROVAÇÃO
    VL_Erro := F_TransacaoCreate(PChar('0113'), PChar(ECaixa.Text), VL_TransacaoID, VL_Tempo);
...
begin
    ...
    VL_Codigo := F_Login(PChar(EHost.Text), StrToInt(EPorta.Text), StrToInt(EID.Text), PChar(Trim(EChave.Lines.Text)),
        C_mensagem, PChar(trim(EIdentificador.Lines.Text)));
...
begin
    ...
    {$IF DEFINED(LINUX64)}
         ETefLib.Text := '../../tef_lib/linux64/tef_lib.so';
         EPinPadLib.Text := '../../pinpad_lib/linux64/pinpad_lib.dll';
...
begin
    ...
    begin
        F_MensagemGetTagPosicao(VL_Mensagem, VL_PosicaoConciliacao, '0036', VL_Bin); // bin

        F_MensagemGetTagPosicao(VL_Mensagem, VL_PosicaoConciliacao, '004D', VL_String); // mensagem com erro
        ...
        F_MensagemGetTagPosicao(VL_Mensagem, VL_PosicaoConciliacao, '004A', VL_String); // mensagem com erro
        ...
        F_MensagemGetTagPosicao(VL_Mensagem, VL_PosicaoConciliacao, '0117', VL_String); // dados da conciliacao
        ...
        begin
            ...
            F_MensagemGetTagPosicao(VL_Venda, VL_PosicaoVenda, '000F', VL_String); // parcela
            MDConciliacao.FieldByName('S_PARCELA').AsString := VL_String;

            F_MensagemGetTagPosicao(VL_Venda, VL_PosicaoVenda, '000E', VL_String); // VALOR
