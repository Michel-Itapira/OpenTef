...
uses
    Classes, SysUtils, def, comunicador, IdContext, funcoes, LbRSA, LbAsym, LbClass, md5, LbCipher;
...
function respondecaixa(VP_Transmissao_ID, VP_Dados: pansichar; VP_ID: integer): integer; cdecl;
function respondeservico(VP_Transmissao_ID, VP_Dados: pansichar; VP_ID: integer): integer; cdecl;
...
begin
    ...
    try
        ...
        begin
            ...
            begin
                VL_ChaveComunicacao := DMCom.CriptoRsa.DecryptString(VL_Mensagem.GetTagAsAstring('010E'));
            ...
            begin
                ...
                VL_Mensagem.AddTag('010E', VL_ChaveComunicacao); // chave de comunicacao criptografada
...
begin
    ...
    try
        try
            ...
            VL_DadosCriptografados := VL_Mensagem.GetTagAsAstring('00E3'); // mensagem criptografada
    ...
    try
        try
            ...
            case VL_Mensagem.Comando() of
                ...
                '0111': comando0111(VP_Transmissao_ID, VL_Mensagem, VP_Conexao_ID, F_ComunicadorServico);
                else
                    F_ServidorRecebimentoLibServico(VP_Erro, PChar(VP_Transmissao_ID), PChar(VP_DadosRecebidos), PChar(VP_ClienteIP),
                        VP_Conexao_ID, PChar(VF_Chave));
            end;
...
begin
    ...
    try
        ...
        begin
            if trim(VF_Identificacao) <> trim(VL_Mensagem.GetTagAsAstring('0108')) then // identificacao
            begin
                Result := 106;
                Exit;
            end;
