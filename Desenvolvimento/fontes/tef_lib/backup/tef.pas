     ...
     2º recebe tag 00E3 então operadora quer que criptografe dados
        ...
        begin
            ...
            begin
                ...
                begin
                    F_MensagemOperador('Obrigado<br>'+'Cartão/bin:'+ftransacao.fMensagem.GetTagAsAstring('00CE'));
                    F_Imprime('Comprovante<br>Autorizacao 123<br>Valor:'+ftransacao.fMensagem.GetTagAsAstring('0013'));
